...
The visuals section of this tab allows the user to create plots based on the selections in the "Visual Inputs" box. One of four possible plots can be generated including a box chart, histogram, box plot, and scatter plot.
